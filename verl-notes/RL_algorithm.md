...
~~你原来的总奖励不是策略乘以相应动作的奖励吗？现在策略除没了，那这个公式还和原来的意义一致吗？ 我个人认为，现在的所谓“策略”体现在求期望$E$上，就像刚才说的，当矫正比例大于1，该动作的权重被放大，这个“权重”除以所有“权重”的和就是另一种意义的“策略”，即在这种意义下的策略乘以相应的奖励，求和得到RL过程的总奖励。~~
